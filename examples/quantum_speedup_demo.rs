...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for (channel_count, scenario_name) in test_scenarios {
        println!("📊 Testing Scenario: {} ({} channels)", scenario_name, channel_count);
        println!("{}", "─".repeat(50));
    ...
    println!("📋 Test Configuration: {} channels", test_channel_count);
    ...
    println!("🚀 Theoretical Quantum Speedup: {:.2}x", theoretical_speedup);
