...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("📊 Testing {} channels establishment", channel_count);
    println!();
    ...
    if parallel_time.as_millis() > 0 {
        ...
        println!("⚡ Efficiency Gain: {:.1}%", efficiency_percent);
    ...
    println!("• Theoretical maximum speedup: {}x for {} channels", channel_count, channel_count);
