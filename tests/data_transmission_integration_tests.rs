...
async fn test_protocol_edge_cases() -> Result<(), SecureCommsError> {
    ...
    println!("✅ Large message (10MB) handled: {:.2} MB/s", throughput);
    ...
    println!("✅ Rapid messages completed: {:.2} messages/second", messages_per_second);
    ...
    for message in special_messages {
        ...
        println!("✅ Special encoding: {} ({} bytes)", 
            display_text, message.as_bytes().len());
    }
